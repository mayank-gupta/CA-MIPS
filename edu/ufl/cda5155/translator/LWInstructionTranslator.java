...
public class LWInstructionTranslator implements Translator {
  @Override
  public boolean doesSatisfy(String instructionBinary) {
    return instructionBinary.substring(32 - 6, 32).matches("110001");
  }
  ...
  public Instruction translate(String instructionBinary) {
    ...
    instruction.setOperator(Operator.LW);
    instruction.setStringRepresentation("LW  R"	+ instruction.getRt().getId() + ", "
